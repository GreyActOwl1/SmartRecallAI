...
<div className=' inline md:hidden'>
 <RxHamburgerMenu size={22} onClick={()=> setIsOpen(!isOpen)} className='cursor-pointer relative text-gray-200 hover:text-white duration-200 transition-all'/> 
   {isOpen && (<div className='absolute w-28 h-auto duration-200 transition-all p-3 mt-2 rounded-lg top-10 right-10 text-gray-400  bg-black border border-gray-300 flex flex-col items-center'>
    ...
    <Link href="" className='hover:text-white text-sm'>Create</Link>
