    ...
    return (
        ...
        <div className='h-auto w-full'>
            <div className='pt-28 md:pt-12  pb-8 w-full flex flex-col gap-y-6 text-center md:flex-row md:gap-x-32 md:max-w-4xl mx-auto'>
                {/* Cards Image*/}
                <Image src="/images/image.png" alt="cards" height={210} width={210} className='place-self-center md:ml-8'/>
...
<Link href=""><button className='w-32 h-10 bg-white flex justify-center items-center text-xs hover:bg-transparent hover:font-light hover:text-gray-300 duration-200 transition-all text-black font-semibold border border-white rounded-lg'>Create</button></Link>
                </div>
                </div>
            </div>
